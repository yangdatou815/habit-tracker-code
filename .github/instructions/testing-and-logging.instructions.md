---
description: A concise reference guide for structured logging with structlog and comprehensive testing strategies
...
Load Playwright MCP server configuration from `.vscode/mcp.json`.
